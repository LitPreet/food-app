...
const Footer = () => {
  return (
    ...
    <section className="footer">
      <div className="brand">
        <div className="h5"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
 ...
 Read me.</div>
        <p>Eat the food you dream about at affordable prices.
      ...
      <div className="subscribe">
        <div className="h5">Subscribe Now</div>
    ...
    <section className="copyright">
      <p><span>©</span> 2023 Rights Reserved, Preet Bhardwaj</p>
      <p>
